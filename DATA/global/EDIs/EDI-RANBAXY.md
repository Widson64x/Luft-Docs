# Configuração de EDI: RANBAXY

Este documento detalha todas as configurações de EDI para o cliente **RANBAXY FARMACEUTICA LTDA**.
...
1.  Apenas o arquivo `OCOREN` é gerado e enviado. Os dados de origem apresentam duas configurações idênticas para este processo.
