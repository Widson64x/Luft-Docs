# Configuração de EDI: MOKSHA8 - SC

Este documento detalha todas as configurações de EDI para o cliente **MOKSHA8 BRASIL INDÚSTRIA E COMÉRCIO DE MEDICAMENTOS LTDA**.
...
3.  Ambos os processos, `CONEMB` e `OCOREN`, são executados **a cada 12 horas, todos os dias**.
