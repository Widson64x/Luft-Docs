...
from LIA_Services import context_service, response_generator, feedback_service
from LIA_Services.llm_config import are_components_available
...
def ask_llm_api():
    ...
    try:
        ...
        if not is_focused_search:
            ...
            final_context, final_sources = response_generator.rerank_and_filter_context(
        ...
        final_answer = response_generator.generate_llm_answer(
